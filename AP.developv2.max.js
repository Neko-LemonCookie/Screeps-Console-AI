...
const DevelopV2_Max = {
    ...
    run: function(room) { try { const s=this.analyze(room); if(!this._shouldRefresh(room)) return; this._publishCreepNeeds(room,s); } catch(e){console.error("[DevelopV2-Max]:",e);} },
