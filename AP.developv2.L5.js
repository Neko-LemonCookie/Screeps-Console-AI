...
const DevelopV2_L5 = {
    ...
    run: function(room) { try { const s=this.analyze(room); if(!this._shouldRefresh(room)) return; this._publishCreepNeeds(room,s); } catch(e){console.log("[DevelopV2-L5] ERROR:",e);} },
